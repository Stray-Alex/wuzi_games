...
from PyQt5 import *
from DoublePlayerGame import Chessman
from DoublePlayerGame import WinLabel
...
class SinglePlayerGame(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        brush = QBrush(QImage('source/游戏界面7.png'))  # 画刷
        p.setBrush(QPalette.Background, brush)  # 设置调色板的背景色
        self.resize(QImage('source/游戏界面7.png').size())
